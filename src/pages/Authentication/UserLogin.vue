    ...
    <base-section class="auth" title="Login" :hiddenTitle="true">
        ...
        <base-form :actions="true" @submit.prevent="submitForm">
            ...
            <transition name="fade" mode="out-in">
                <error-message v-if="!formIsValid">Please enter a valid email and password.</error-message>
            </transition>
            <template v-slot:actions>
                <base-button type="submit" class="is-secondary">Login</base-button>
            </template>
        </base-form>
    </base-section>
</template>
...
export default {
    ...
    setup() {
        ...
        //     if (emailInput.value || passwordInput.value && !isAuth.value) {
